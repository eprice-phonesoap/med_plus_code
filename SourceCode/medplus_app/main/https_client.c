...
@file			  http_client.c
@author			  Jey
@brief			  HTTP Client related functions
...
typedef struct http_request_context_ {
    ...
    char tls_request_buffer[1024];
    size_t tls_request_buffer_size;

    char tls_response_buffer[4096];
...
static http_request_context_t ctx = {0};// = malloc(sizeof(http_request_context_t));
